...
import { CardActionArea,Fab, Divider, Paper, Card } from '@material-ui/core';
...
export default function SpumoModalTrigger() {
  ...
  return (
    <div>
      ...
      <CardActionArea style={{borderRadius:'20px'}}  onClick={handleClickOpen} className={classes.actionArea}>
         <DeleteForeverOutlinedIcon color="secondary" className={classes.focusHighlight} style={{fontSize:90}}/>
      ...
      >
        <DialogTitle id="alert-dialog-slide-title">{"SpuMo"}</DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
            <SpumoMullAppBarTable/>
              <TableSpumoMull/>
          </DialogContentText>
        </DialogContent>
        <DialogActions>
