...
export default function WattModalTrigger() {
  ...
  return (
    <div>
      ...
      <CardActionArea style={{borderRadius:'20px'}}  onClick={handleClickOpen} className={classes.actionArea}>
         <AssessmentOutlinedIcon color="secondary" className={classes.focusHighlight} style={{fontSize:90}}/>
         <Divider variant="middle" />
         <h1> Watt-kartierung</h1>
         </CardActionArea>
